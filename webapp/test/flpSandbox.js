		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#busticketuserbusbooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"busticketuserbusbooking-display": {
								"semanticObject": "busticketuserbusbooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bus.ticket.userbusbooking",
									"url": sap.ui.require.toUrl("bus/ticket/userbusbooking")
								}
							}
						}
					}
